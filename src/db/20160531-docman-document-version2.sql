...
create trigger doc_data_version_ts_update AFTER INSERT OR DELETE OR UPDATE ON doc_data_version FOR EACH ROW EXECUTE PROCEDURE update_vectors('doc_data_version');
