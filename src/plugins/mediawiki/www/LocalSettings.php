...
if (!isset($fusionforge_plugin_mediawiki_LocalSettings_included)) {
	...
	$project_dir = forge_get_config('projects_path', 'mediawiki').'/'.$fusionforgeproject;
	...
	*/
	...
	$GLOBALS['wgHooks']['UserGetEmailAuthenticationTimestamp'][] = 'FusionForgeMWUserGetEmailAuthenticationTimestamp';
