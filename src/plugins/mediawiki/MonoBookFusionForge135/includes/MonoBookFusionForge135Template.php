 ...
 * @ingroup Skins
 */
class MonoBookFusionForge135Template extends BaseTemplate {
	...
	public function execute() {
		...
		$html .= $GLOBALS['HTML']->bodyHeader($this->params);
		$html .= "<div id=\"ff-mw-wrapper\"><div style=\"font-size:x-small;\">\n";
		$html .= "<!-- FUSIONFORGE BodyHeader END -->\n";
		...
		$html .= "</div></div>\n";
		$html .= $GLOBALS['HTML']->footer($this->params);
