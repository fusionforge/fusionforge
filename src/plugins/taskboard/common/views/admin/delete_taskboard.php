...
$taskboard->header(
	array(
		'title' => $taskboard->getName()._(': ')._('Administration')._(': ')._('Delete Task Board'),
...
echo html_e('div', array(), _('You are about to permanently and irretrievably delete this Task Board!'));
