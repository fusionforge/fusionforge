...
class TaskBoardColumn extends Error {
	...
	function getResolutions() {
		...
		if (!$res) {
			$this->setError('TaskBoardColumn: cannot get resolutions');
			return false;
		}
		$resolutions= array();
	...
	function getDropRules() {
		if( !$this->drop_rules ) {
			...
			if (!$res) {
				$this->setError('TaskBoardColumn: cannot get drop rules');
				return false;
			}
	...
	function getResolutionByDefault() {
		if( !$this->getDropRulesByDefault() ) {
			$this->setError('TaskBoardColumn: cannot get resolution by default');
			return false;
		}
