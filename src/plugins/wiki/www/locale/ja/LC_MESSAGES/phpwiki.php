...
$locale["%s bytes"] = "%s バイト";
$locale["%s bytes written"] = "%s  バイト書き込みました。";
$locale["%s is empty."] = "%s が空です。";
$locale["%s: Bad action"] = "%s: 正しくない操作です。";
$locale["%s: Can't open dba database"] = "%s: dba データベースをオープン出来ません。";
$locale["%s: file not found"] = "%s: ファイルが見つかりません。";
$locale["%s: not defined"] = "%s: 未定義でした。";
$locale["'%s': Bad page name"] = "'%s': ページ名が正しくありません";
$locale["(diff)"] = "(差分)";
...
$locale["AllUsers"] = "全ユーザー";
$locale["Allowed protocols"] = "許可するプロトコル一覧";
$locale["Appearance"] = "外観";
$locale["Application name"] = "アプリケーション名";
...
$locale["Browsing pages"] = "ページを閲覧中です。";
$locale["Cache statistics"] = "キャッシュ統計";
$locale["Calendar"] = "カレンダー";
$locale["Cannot create directory '%s'"] = "ディレクトリ '%s' を作成出来ません。";
$locale["Change Password"] = "パスワード変更";
...
$locale["Current language: '%s'"] = "現在の言語: %s";
$locale["Current theme: '%s'"] = "現在のテーマ: %s";
$locale["Date Format"] = "データフォーマット";
$locale["DebugInfo"] = "デバグ情報";
$locale["Default theme: '%s'"] = "デフォルトテーマ: %s";
$locale["Describe %s here."] = "ここに%sを記述します。";
...
$locale["Loading files"] = "ファイルを読込み中です。";
...
$locale["Next"] = "次へ";
$locale["Next Month"] = "次の月";
$locale["No changes found"] = "変更点が見つかりませんでした。";
$locale["No changes."] = "変更しませんでした。";
...
$locale["PageGroup"] = "ページグループ";
$locale["PageHistory"] = "ページ履歴";
$locale["PageHistory for %s"] = "%s のページ履歴";
$locale["PageInfo"] = "ページ情報";
$locale["Password:"] = "パスワード:";
$locale["Personal language:"] = "個人言語";
$locale["Personal theme:"] = "個人テーマ";
$locale["PhotoAlbum"] = "フォトアルバム";
$locale["PhpHighlight"] = "PHPハイライト";
$locale["Please continue editing.  (You'll find your %s at the bottom of the page.)"] = "編集を続けて下さい。 (%s のページの下部も見てください)";
$locale["Plugin"] = "プラグイン";
...
$locale["Previous"] = "前へ";
$locale["Previous Author"] = "前の編集者";
$locale["Previous Month"] = "前の月";
$locale["Previous Revision"] = "前のリビジョン";
$locale["Printer"] = "プリンター";
$locale["Purge Markup Cache"] = "マークアップキャッシュの破棄";
$locale["RandomPage"] = "ランダムページ";
$locale["Raw HTML"] = "生のHTML";
$locale["RecentChanges"] = "変更履歴";
$locale["Redirect"] = "転送";
$locale["References"] = "参照一覧";
$locale["Remove Page"] = "ページ削除";
$locale["Remove selected pages"] = "選択ページを全て削除";
$locale["Removing pages"] = "ページを削除中です。";
...
$locale["See: %s"] = "参照: %s";
$locale["Select: "] = "選択:";
$locale["Serialized file %s"] = "シリアライズファイル %s";
$locale["Sidebar"] = "スライドバー";
...
$locale["Subpage"] = "サブページ";
$locale["Summary"] = "要約";
$locale["Supported languages"] = "サポート言語一覧";
$locale["Supported themes"] = "サポートテーマ一覧";
$locale["Synopsis"] = "要約";
$locale["SystemInfo"] = "システム情報";
$locale["Theme"] = "テーマ";
$locale["Time Zone"] = "タイムゾーン";
$locale["Title Search"] = "タイトル検索";
$locale["TitleSearch"] = "タイトル検索";
$locale["Today"] = "今日";
$locale["Top & bottom toolbars"] = "上部と下部のツールバー";
$locale["Total %d plugins: "] = "合計 %d プラグイン";
$locale["Total of %d themes: "] = "総テーマ数: %d";
...
$locale["User statistics"] = "ユーザー統計";
$locale["UserId"] = "ユーザーID";
$locale["UserId:"] = "ユーザーID:";
