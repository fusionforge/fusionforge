...
$locale["ACL deleted for page “%s”"] = "ACL für Seite »%s« gelöscht";
...
$locale["Analyze preferences based on voting budget and ratings."] = "Analysiere Empfehlungen auf Grund von Bewertungen.";
...
$locale["Cannot rename. New page name too long."] = "Kein Ausgewählte. Seite Name zu lang.";
...
$locale["Create a Wiki Category Page."] = "Erzeuge eine neue Wiki-Seite.";
...
$locale["Del/+"] = "Lö/+";
$locale["Delete ACL"] = "Lösche diese ACL";
...
$locale["Display a list of randomly chosen pages or redirects to a random page."] = "Eine liste der zufälliger ausgewählter Seiten zeigen oder nach einer zufälliger ausgewählter Seite weiterleiten.";
$locale["Display a set of photos listed in a text file with optional descriptions."] = "Zeigt die Liste der Bilder in einer Textdatei an, mit optionalen Beschreibungen.";
$locale["Display a url in a separate frame inside our body. Only one frame allowed."] = "Zeigt eine URL in einem eigenen (oder gesonderten) Frame innerhalb der Seite. Nur ein Frame ist erlaubt.";
...
$locale["Error sending e-mail with password for user %s."] = "Fehler beim Versenden der E-Mail mit dem neuen Passwort für Benutzer %s.";
...
$locale["Get an e-mail notification at changes of the following pages:"] = "E-Mail Nachricht bei Änderung folgender Seiten:";
...
$locale["List referenced page names which do not exist yet."] = "Zeige verlinkte Seiten, die noch nicht bearbeitet bzw. erzeugt wurden.";
...
$locale["ModeratedPage Notification Error: Couldn't send e-mail"] = "ModerierteSeite Benachrichtigungsfehler: Konnte kein E-Mail versenden";
...
$locale["No e-mails for the moderators defined"] = "Keine E-Mails für Moderatoren definiert";
...
$locale["No revert: no page content"] = "Kein Zurückspeichern: leerer Seiteninalt";
$locale["No revert: same version page"] = "Kein Zurückspeichern: selbe Version der Seite";
...
$locale["Note, that user accounts with bouncing e-mails will be disabled."] = "Beachten Sie bitte, dass Benutzer mit ungültigen E-Mail-Addressen gelöscht werden.";
$locale["Note:"] = "Hinweis:";
...
$locale["Provide for raw HTML within wiki pages."] = "Einer Zusatzprogramm der reine HTML-Befehle im Wiki-Seiten abrufbar stellt.";
$locale["Provide weather reports from the Internet."] = "Der PhpWetter plugin gibt Auskunft zur Wetterlage vom Internet.";
...
$locale["Purge cancelled"] = "Löschen abgebrochen";
...
$locale["Redirect to an external web site based on form input."] = "Weiterleitung der Suche zu einer externen Webseite aufgrund einer Formulareingabe.";
...
$locale["Remove cancelled"] = "Löschen abgebrochen";
...
$locale["Revert cancelled"] = "Zurückspeichern abgebrochen";
$locale["Revert: %s"] = "Zurückspeichern: %s";
$locale["Revert: missing required version argument"] = "Zurückspeichern: Parameter version muß angegeben werden";
...
$locale["SearchReplace"] = "Suchen und Ersetzen";
...
$locale["Send e-mail"] = "Versende E-Mail";
...
$locale["Simple RSS Feed aggregator."] = "Einfaches RSS Feed Plugin.";
...
$locale["User Preferences"] = "BenutzerEinstellungen";
...
$locale["Warning: You are editing an old revision. Saving this page will overwrite the current version."] = "Wenn Sie diese Seite jetzt speichern, wird die aktuelle Version überschrieben.";
$locale["Watch Page"] = "Seite beobarchten";
$locale["WatchPage"] = "SeiteBeobarten";
$locale["WatchPage cancelled"] = "SeiteBeobarten abgebrochen";
...
$locale["e-mail not yet verified."] = "E-Mail noch nicht bestätigt.";
$locale["e-mail verified."] = "E-Mail bestätigt.";
