...
$locale["%d best outgoing links: "] = "%d mejores enlaces de salida: ";
$locale["%d minutes"] = "%d minutas";
$locale["%d most popular nearby: "] = "%d las más populares: ";
...
$locale["%s bytes written"] = "%s octetos";
$locale["%s days"] = "%s dias";
$locale["%s has no subpages defined."] = "%s: no hace ninguna página secundaria definir.";
...
$locale["%s: Date of new revision is %s"] = "%s: La fecha de la nueva revisión es %s";
$locale["%s: action forwarded to a moderator."] = "%s: acción remitida a un asesor.";
...
$locale["'%s': corrupt file"] = "'%s': archivo corrupto";
$locale["(Copy your changes to the clipboard. You can try editing a different page or save your text in a text editor.)"] = "Copie sus cambios al portapapeles o a otro sitio temporal (p.ej. editor de textos).";
$locale["(Redirected from %s)"] = "(vuelto a dirigir de %s)";
$locale["- saved to database as version %d"] = "- ahorrado a la base de datos como versión %d";
$locale["- version %d saved to database as version %d"] = "- versión %d ahorrada a la base de datos como versión %d";
$locale["... copied to %s"] = "... copia de [%s]";
...
$locale["An unnamed PhpWiki"] = "Un PhpWiki sin un nombre";
$locale["Anonymous Users"] = "Usuarios Anónimos";
$locale["Argument '%s' not declared by plugin."] = "Parámetro '%s' no declarada por plugin.";
$locale["Article"] = "Artículo";
$locale["Attempting to use the directory '%s' instead."] = "El procurar utilizar el directorio '%s' en lugar de otro.";
...
$locale["Bogo Users"] = "Usuarios Bogo";
$locale["Bold text"] = "Texto en negrilla";
$locale["Bold text [alt-b]"] = "Texto en negrilla [alt-b]";
$locale["Browsing pages"] = "Páginas el hojear";
...
$locale["CategoryGroup"] = "GrupoCategoría";
$locale["CategoryHomepage"] = "CategoríaHomepage";
$locale["CategoryPage"] = "CategoríaPágina";
$locale["Change Password"] = "Change Contraseña";
$locale["Change page attributes"] = "Cambie las cualidades de la página";
$locale["Changes"] = "Cambios";
$locale["Check to add this ACL"] = "Compruebe para agregar este ACL";
$locale["Chown"] = "Cambie a dueño";
$locale["Click a button to get an example text"] = "Chasque un botón para conseguir un texto del ejemplo";
$locale["Click to de-/select all pages"] = "Tecleo para de-/seleccionar todas las páginas";
$locale["Click to reverse sort order"] = "Tecleo para invertir orden de la clase";
$locale["Click to sort by %s"] = "Clase por %s";
$locale["Close"] = "Cierre";
$locale["Columns: %s."] = "Columnas: %s.";
$locale["Comment"] = "Commentario";
$locale["Comment modified on %s by %s"] = "Comentario modificado en %s por %s";
$locale["Comments on %s by %s."] = "Comentarios sobre %s por %s.";
$locale["Complete."] = "Acabado.";
...
$locale["CreatePage"] = "CreeLaPágina";
$locale["CreateToc"] = "CreeToc";
$locale["Created by CreatePage"] = "Cree par CreeLaPágina";
$locale["Created directory '%s' for the page dump..."] = "Directorio creado '%s' para la descarga de la página...";
$locale["Creator"] = "Creador";
$locale["DB admin password:"] = "DB admin contraseña:";
$locale["DB admin user:"] = "DB admin username:";
$locale["Default InterWiki map file not loaded."] = "Archivo del InterMapa de Wiki del defecto no cargado.";
...
$locale["Go"] = "Aceptar";
$locale["Grant"] = "Concesión";
$locale["Group %s does not exist"] = "El grupo %s no existe";
$locale["Group page '%s' does not exist"] = "La página '%s' del grupo no existe";
$locale["Group/User"] = "Grupo/Usuario";
$locale["H"] = "Al";
$locale["Headline text"] = "Texto del título";
$locale["Height"] = "Altura";
$locale["Help"] = "Ayuda";
$locale["Help/CalendarListPlugin"] = "Ayuda/CalendarioListaPlugin";
$locale["Help/CalendarPlugin"] = "Ayuda/CalendarioPlugin";
$locale["Help/CreateTocPlugin"] = "Ayuda/CreeToc";
$locale["Help/GoodStyle"] = "Ayuda/BuenEstilo";
$locale["Help/IncludePagePlugin"] = "Ayuda/BuscarPágina";
$locale["Help/OldTextFormattingRules"] = "Ayuda/ViejoReglasDeFormatoDeTexto";
$locale["Help/TextFormattingRules"] = "Ayuda/ReglasDeFormatoDeTexto";
...
$locale["I'm sorry, there is no such page as %s."] = "Estoy apesadumbrado, allí no soy ninguna página tal como %s.";
$locale["I'm sorry.  Version %d of %s is not in the database."] = "Estoy apesadumbrado.  La versión %d de %s no está en la base de datos.";
$locale["Ignore wiki formatting"] = "No haga caso del formato del wiki";
$locale["Illegal chars %s removed"] = "Los carbones ilegales %s quitaron";
...
$locale["Insert PageLink"] = "Inserte el AcoplamientoDeLaPágina";
$locale["Insert Plugin"] = "Relleno Plugin";
$locale["Insert Template"] = "Inserte la plantilla";
$locale["Insert non-formatted text here"] = "Inserte el texto sin formatear aquí";
$locale["Insufficient permissions."] = "Permisos escasos.";
$locale["InterWiki"] = "InterWiki";
$locale["InterWikiMap"] = "InterMapaDeWiki";
$locale["InterWikiSearch"] = "InterWikiBúsqueda";
$locale["Invalid [] syntax ignored"] = "[] el sintaxis inválido no hizo caso";
$locale["Invalid password or userid."] = "Contraseña o userid inválida.";
$locale["Invalid password."] = "Contraseña inválido.";
$locale["Invalid username '%s' for LDAP Auth"] = "Username inválido ' %s' para LDAP Auth";
$locale["Invalid username."] = "Username inválido.";
$locale["Italic text"] = "Texto del itálico";
$locale["Italic text [alt-i]"] = "Texto del itálico [alt-i]";
$locale["Last"] = "Final";
...
$locale["ListSubpages"] = "ListaPáginasSecundaria";
$locale["Load File"] = "Archivo De la Carga";
$locale["LoadDump"] = "CargaDescarga";
$locale["Loading '%s'"] = "'%s' que carga";
$locale["Loading InterWikiMap from external file %s."] = "Cargamento InterMapaDeWiki del archivo externo %s.";
$locale["Loading up virgin wiki"] = "El cargar encima de wiki virginal";
$locale["Lock"] = "Bloqueada";
$locale["Lock Page"] = "Bloquear Página";
$locale["Locked"] = "Bloqueada";
$locale["Locking pages"] = "Bloquear páginas";
$locale["MIME file %s"] = "Archivo %s del MIME";
$locale["Members:"] = "Miembros:";
$locale["Merge Edit"] = "Fusión Editar";
$locale["Merge and Edit: %s"] = "Fusión y Editar: %s";
$locale["Message"] = "Mensaje";
$locale["Method '%s' not implemented in this GROUP_METHOD %s"] = "Método ' %s' no puesto en ejecucio'n en este GROUP_METHOD %s";
$locale["Minor Edit"] = "El Menor de edad Corrige";
$locale["Missing PagePermission:"] = "Permiso que falta de la página:";
...
$locale["Next Month"] = "El Mes Próximo";
$locale["No LDAP in this PHP version"] = "Ningún LDAP en esta versión de PHP";
$locale["No changes found"] = "Ningunos cambios encontrados";
$locale["No changes."] = "Ningunos cambios.";
$locale["No comments found"] = "Ningunos comentarios encontrados";
$locale["No or not enough GROUP_DB SQL statements defined"] = "No o no bastantes declaraciones de GROUP_DB SQL definió";
$locale["No or unsupported GROUP_METHOD defined"] = "No o GROUP_METHOD sin apoyo definido";
$locale["No uploaded file to upload?"] = "¿Ningún archivo uploaded a upload?";
$locale["None"] = "Ninguna";
$locale["Note:"] = "Nota:";
$locale["Old UserPage %s without stored password updated with empty password. Set a password in your UserPreferences."] = "Viejo UserPage %s sin la contraseña almacenada puesta al día con contraseña vacía. Fije una contraseña en su UsuarioPreferencias.";
$locale["Older page:"] = "Página más viejo:";
$locale["Oops! Revision %s of %s seems to have been deleted!"] = "¡Oops! ¡La revisión %s de %s se parece haber sido suprimida!";
$locale["Operation undone"] = "Operación deshecha";
$locale["Optimizing database"] = "Base de datos óptima";
$locale["OrphanedPages"] = "BuscarPágina";
$locale["Other diffs:"] = "Otros diffs:";
$locale["Other version"] = "Altro versión";
...
$locale["Password cannot be changed."] = "La contraseña no puede ser cambiada.";
...
$locale["Please contact your PhpWiki administrator for assistance."] = "Entre en contacto con por favor a su administrador de PhpWiki para la ayuda.";
$locale["Please ensure that %s is writable, or redefine %s in config/config.ini."] = "Asegúrese por favor de que %s sea escribible, o redefina %s en config/config.ini.";
$locale["Please set ENCRYPTED_PASSWD to false in config/config.ini and probably change ADMIN_PASSWD."] = "En ENCRYPTED_PASSWD por favor fijado a falso config/config.ini y probablemente cambio ADMIN_PASSWD.";
$locale["Please set ENCRYPTED_PASSWD to true in config/config.ini."] = "ENCRYPTED_PASSWD por favor fijado a verdad en config/config.ini.";
$locale["Please set a password in UserPreferences."] = "Fije por favor una contraseña en UsuarioPreferencias.";
...
$locale["Previous Author"] = "Autor Anterior";
$locale["Previous Major Revision"] = "Revisión Importante Anterior";
...
$locale["Save"] = "Guardar";
$locale["Saved: %s"] = "Guardar: %s";
$locale["Saving this page will overwrite the current version."] = "Ahorrando esta página sobreescribirá la versión actual.";
...
$locale["Set Password"] = "Set Contraseña";
$locale["Set USE_DB_SESSION to false."] = "Fije USE_DB_SESSION a falso.";
$locale["SetAcl"] = "Fije El Acl";
$locale["Show changes for:"] = "Demuestre los cambios para:";
$locale["Sign In"] = "Muestra Adentro";
...
$locale["String \"%s\" not found."] = "Secuencia \"%s\" no encontrado.";
$locale["SubPages of %s:"] = "PáginasSecundaria de %s:";
...
$locale["The %d most recent %s during the past %s days are listed below."] = "Los %d la mayoría del %s reciente durante los últimos días de %s se enumeran abajo.";
$locale["The %d most recent %s during the past day are listed below."] = "Los %d la mayoría del %s reciente durante el último día se enumeran abajo.";
$locale["The %d oldest %s are listed below."] = "Los %d el %s más viejo se enumeran abajo.";
$locale["The %d oldest %s during the past %s days are listed below."] = "Los %d el %s más viejo durante los últimos días de %s se enumeran abajo.";
$locale["The %d oldest %s during the past day are listed below."] = "Los %d el %s más viejo durante el último día se enumeran abajo.";
$locale["The %s files are in the %s directory. Please read the INSTALL file and move the database to a permanent location or risk losing all the pages!"] = "Los archivos de %s están en el directorio de %s. ¡Lea por favor el archivo de la INSTALACIÓN y mueva la base de datos a una localización permanente o arriesgúela el perder de todas las páginas!";
$locale["The DBA handler %s is unsupported!"] = "¡El tratante %s del DBA está sin apoyo!";
$locale["The PhpWiki access log file"] = "El fichero de diario del acceso de PhpWiki";
$locale["The crypt function is not available in this version of PHP."] = "La función de la cripta no está disponible en esta versión de PHP.";
$locale["The length of the password is shorter than the system policy allows."] = "La longitud de la contraseña es más corta que la política del sistema permite.";
...
$locale["The most recent %s during the past %s days are listed below."] = "Los %s más recientes durante los últimos días de %s se enumeran abajo.";
$locale["The most recent %s during the past day are listed below."] = "Los %s más recientes durante el último día se enumeran abajo.";
$locale["The session.save_path directory"] = "El directorio de session.save_path";
$locale["There is no image creation data available to id '%s'. Please reload referring page."] = "No hay datos de la creación de la imagen disponibles para la identificación '%s '. Por favor recarga que refiere la página.";
...
$locale["Top & bottom toolbars"] = "Toolbars superiores y inferiores";
$locale["Topic"] = "Asunto";
$locale["Type word above:"] = "Mecanografíe la palabra arriba:";
$locale["Typed in verification word mismatch ... are you a bot?"] = "¿Mecanografían en la unión mal hecha de la palabra de la verificación... le un BOT?";
$locale["UNOBTAINABLE"] = "INALCANZABLE";
$locale["USER"] = "USUARIO";
$locale["Unable to bind LDAP server %s using %s %s"] = "Incapaz atar el servidor %s de LDAP usando %s %s";
$locale["Unable to connect to IMAP server "] = "Incapaz conectar con el IMAP el servidor ";
$locale["Unable to connect to LDAP server %s"] = "Incapaz conectar con el servidor %s de LDAP";
$locale["Undefined method %s for special group %s"] = "Método indefinido %s para el grupo especial %s";
$locale["Undo"] = "Deshaga";
$locale["Undo Search & Replace"] = "Deshaga La Búsqueda Y Substitúyala";
$locale["Undo disabled"] = "Deshaga lisiado";
$locale["Unexpected EOF in zip file"] = "EOF inesperado en archivo del zip";
$locale["UnfoldSubpages"] = "IncluyaPáginasSecundaria";
$locale["Unknown special group '%s'"] = "Grupo especial desconocido '%s'";
$locale["Unlock"] = "Desbloquear";
$locale["Unlock Page"] = "Desbloquear Página";
$locale["Unlocking pages"] = "Desbloquear páginas";
$locale["Unsupported ACL access type %s ignored."] = "Tipo sin apoyo %s del acceso del ACL no hecho caso.";
$locale["Unsupported argument: %s=%s"] = "Discusión sin apoyo: %s=%s";
...
$locale["You must specify a directory to dump to"] = "Usted debe especificar un directorio para descargar a";
$locale["You must wait for moderator approval."] = "Usted debe esperar la aprobación del asesor.";
$locale["You stored an empty password in your '%s' page."] = "Usted almacenó una contraseña vacía en su página de '%s'.";
$locale["Your WikiDB DB backend '%s' cannot be used for DbSession."] = "Su DB '%s' backend de WikiDB no se puede utilizar para DbSession.";
$locale["Your access permissions are only for a BogoUser."] = "Sus permisos de acceso están solamente para un BogoUser.";
$locale["Your are probably trying to edit/create an invalid version of this page."] = "Su están intentando corregir/crean probablemente una versión inválida de esta página.";
$locale["Your careful attention to detail is much appreciated."] = "Se agradece una cuidadosa atención a los detalles.";
$locale["Your changes can not be saved as they are, since doing so would overwrite the other author's changes. So, your changes and those of the other author have been combined. The result is shown below."] = "Sus cambios no se pueden ahorrar como son, desde hacer así que sobreescribirían los cambios del otro autor. Así pues, se han combinado sus cambios y los del otro autor. El resultado se demuestra abajo.";
...
$locale["couldn't move %s to %s"] = "no podía mover %s a %s";
$locale["couldn't open file '%s' for writing"] = "Error al escribir la página '%s'";
$locale["create this page"] = "para crear esta página";
$locale["current version"] = "versión actual";
$locale["days"] = "dias";
$locale["diff this page"] = "para diff esta página";
$locale["download a html zip dump from this wiki"] = "para descargar un HTML relampague la descarga de este wiki";
$locale["download a zip dump from this wiki"] = "para descargar un cierre relámpago descargue de este wiki";
...
$locale["has edit conflicts - skipped"] = "tiene corregir los conflictos - saltados";
$locale["hours"] = "horas";
$locale["latest comment by "] = "el comentario más último cerca ";
$locale["load files into this wiki"] = "para cargue los archivos en este wiki";
$locale["lock this page"] = "para trabar esta página";
$locale["locked"] = "bloqueada";
...
$locale["upload a zip dump"] = "para upload una descarga del cierre relámpago";
$locale["users"] = "usuarios";
