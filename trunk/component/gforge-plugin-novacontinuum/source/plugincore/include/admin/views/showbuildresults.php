			...
			foreach ($buildResults as $key=>$value) {
				...
				<tr align="center">
					...
					<td><?php
							...
							echo $diffTime;?></td>
					<td><a href="/plugins/novacontinuum/admin/index.php?view=showbuildresult&buildresultid=<?php echo $value->id;?>&projectid=<?php echo $projectid;?>&group_id=<?php echo $group_id;?>"><img src="imgs/<?php echo $value->getStateImage();?>" alt="state" border="none"/></a></td>
