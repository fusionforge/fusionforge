...
$cat_box=html_build_select_box_from_arrays ($cat_id_arr,$cat_name_arr,'_category_id',$_category_id,true,_('MISSINGTEXT:pm/none:TEXTMISSING')._('MISSINGTEXT:pm/none:TEXTMISSING'));
