...
function my_hide_url ($svc, $db_item_id, $item_id, $count, $hide) {
    ...
    if ($hide) {
                $hide_url= '<a href="?hide_'.$svc.'=0&hide_item_id='.$db_item_id.'"><img src="../themes/images/pointer_right.png" align="middle" border="0" title="'._('Expand').'" alt="'._('Expand').'"></a>&nbsp;';
                $hide_now = true;
    } else {
                $hide_url= '<a href="?hide_'.$svc.'=1&hide_item_id='.$db_item_id.'"><img src="../themes/images/pointer_down.png"  align="middle" border="0" title="'._('Collapse').'" alt="'._('Collapse').'"></a>&nbsp;';
                $hide_now = false;
    }
