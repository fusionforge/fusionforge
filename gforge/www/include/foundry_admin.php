 ...
 *
 * @version   $Id: foundry_admin.php,v 1.32 2001/06/08 18:21:30 dbrogdon Exp $
 */
	...
	if ($func=='rmproject') {
		...
		*/
		...
		if (eregi('[^0-9,]',$trove_categories)) {
			...
			$res=db_query("UPDATE foundry_data 
...
project_admin_header(array('title'=>"Project Admin: ".group_getname($group_id),'group'=>$group_id,'pagename'=>'foundry_admin','sectionvals'=>array(group_getname($group_id))));
