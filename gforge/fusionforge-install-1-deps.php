...
function installRedhat() {
	...
	passthru("yum -y install httpd php mailman cvs postgresql postgresql-libs postgresql-server postgresql-contrib perl-URI php-pgsql subversion mod_dav_svn postfix rcs php-gd mod_ssl wget openssh which htmlpurifier php-mbstring php-jpgraph poppler-utils php-pecl-zip antiword");
}
