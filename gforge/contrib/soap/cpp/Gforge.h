...
//gsoap tns schema namespace: http://gforge.org
...
//gsoap tns service namespace: http://gforge.org

//gsoap tns service location: http://gforge.org/soap/SoapAPI.php
...
//gsoap tns service method-action: user "http://gforge.org/soap/SoapAPI.php"
tns__user( xsd__string  func, tns__ArrayOfstring * params, tns__userResponse * out );
//gsoap tns service method-action: logout "http://gforge.org/soap/SoapAPI.php"
tns__logout( tns__logoutResponse * out );
//gsoap tns service method-action: hello "http://gforge.org/soap/SoapAPI.php"
tns__hello( xsd__string  parm, tns__helloResponse * out );
//gsoap tns service method-action: getNumberOfActiveUsers "http://gforge.org/soap/SoapAPI.php"
tns__getNumberOfActiveUsers( tns__getNumberOfActiveUsersResponse * out );
//gsoap tns service method-action: bugList "http://gforge.org/soap/SoapAPI.php"
tns__bugList( xsd__string  sessionkey, xsd__string  project, tns__bugListResponse * out );
//gsoap tns service method-action: bugUpdate "http://gforge.org/soap/SoapAPI.php"
...
//gsoap tns service method-action: group "http://gforge.org/soap/SoapAPI.php"
tns__group( xsd__string  func, tns__ArrayOfstring * params, tns__groupResponse * out );
//gsoap tns service method-action: getPublicProjectNames "http://gforge.org/soap/SoapAPI.php"
tns__getPublicProjectNames( tns__getPublicProjectNamesResponse * out );
//gsoap tns service method-action: getSiteStats "http://gforge.org/soap/SoapAPI.php"
tns__getSiteStats( tns__getSiteStatsResponse * out );
//gsoap tns service method-action: login "http://gforge.org/soap/SoapAPI.php"
tns__login( xsd__string  userid, xsd__string  passwd, tns__loginResponse * out );
//gsoap tns service method-action: bugAdd "http://gforge.org/soap/SoapAPI.php"
tns__bugAdd( xsd__string  sessionkey, xsd__string  project, xsd__string  summary, xsd__string  details, tns__bugAddResponse * out );
//gsoap tns service method-action: getNumberOfHostedProjects "http://gforge.org/soap/SoapAPI.php"
tns__getNumberOfHostedProjects( tns__getNumberOfHostedProjectsResponse * out );
//gsoap tns service method-action: bugFetch "http://gforge.org/soap/SoapAPI.php"
