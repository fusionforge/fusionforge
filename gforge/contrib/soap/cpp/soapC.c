...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.3 rev 1 2003-07-20 11:46:21 GMT")
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_getelement(struct soap *soap, int *type)
{
	...
	case SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint:
		return soap_in_tns__ArrayOfSiteStatsDataPoint(soap, NULL, NULL, "tns:ArrayOfSiteStatsDataPoint");
	...
	case SOAP_TYPE_tns__ArrayOfGroupObject:
		return soap_in_tns__ArrayOfGroupObject(soap, NULL, NULL, "tns:ArrayOfGroupObject");
	...
	case SOAP_TYPE_PointerTotns__ArrayOfSiteStatsDataPoint:
		return soap_in_PointerTotns__ArrayOfSiteStatsDataPoint(soap, NULL, NULL, "tns:ArrayOfSiteStatsDataPoint");
	case SOAP_TYPE_PointerTotns__ArrayOfGroupObject:
		return soap_in_PointerTotns__ArrayOfGroupObject(soap, NULL, NULL, "tns:ArrayOfGroupObject");
	...
	default:
		...
		if (!soap_match_tag(soap, soap->type, "tns:ArrayOfSiteStatsDataPoint"))
		{	*type = SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint;
			return soap_in_tns__ArrayOfSiteStatsDataPoint(soap, NULL, NULL, NULL);
		}
		...
		if (!soap_match_tag(soap, soap->type, "tns:ArrayOfGroupObject"))
		{	*type = SOAP_TYPE_tns__ArrayOfGroupObject;
			return soap_in_tns__ArrayOfGroupObject(soap, NULL, NULL, NULL);
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_putelement(struct soap *soap, const void *ptr, const char *tag, int id, int type)
{
	...
	case SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint:
		return ((tns__ArrayOfSiteStatsDataPoint *)ptr)->soap_out(soap, tag, id, "tns:ArrayOfSiteStatsDataPoint");
	case SOAP_TYPE_tns__getSiteStatsResponse:
	...
	case SOAP_TYPE_tns__ArrayOfGroupObject:
		return ((tns__ArrayOfGroupObject *)ptr)->soap_out(soap, tag, id, "tns:ArrayOfGroupObject");
	case SOAP_TYPE_tns__groupResponse:
	...
	case SOAP_TYPE_PointerTotns__ArrayOfSiteStatsDataPoint:
		return soap_out_PointerTotns__ArrayOfSiteStatsDataPoint(soap, tag, id, (tns__ArrayOfSiteStatsDataPoint *const*)ptr, "tns:ArrayOfSiteStatsDataPoint");
	case SOAP_TYPE_PointerTotns__ArrayOfGroupObject:
		return soap_out_PointerTotns__ArrayOfGroupObject(soap, tag, id, (tns__ArrayOfGroupObject *const*)ptr, "tns:ArrayOfGroupObject");
	case SOAP_TYPE_PointerTotns__Bug:
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_instantiate(struct soap *soap, int t, const char *type, const char *arrayType, size_t *n)
{
	...
	case SOAP_TYPE_tns__ArrayOfGroupObject:
		return (void*)soap_instantiate_tns__ArrayOfGroupObject(soap, -1, type, arrayType, n);
	case SOAP_TYPE_tns__groupResponse:
	...
	case SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint:
		return (void*)soap_instantiate_tns__ArrayOfSiteStatsDataPoint(soap, -1, type, arrayType, n);
	case SOAP_TYPE_tns__getSiteStatsResponse:
		...
		{	struct soap_clist *q = *cp;
			*cp = q->next;
			...
			case SOAP_TYPE_tns__ArrayOfstring:
				...
				break;
			case SOAP_TYPE_tns__ArrayOfGroupObject:
				DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_delete(tns__ArrayOfGroupObject, %d)\n", q->size));
				if (q->size < 0)
					delete (tns__ArrayOfGroupObject*)q->ptr;
				else
					delete[] (tns__ArrayOfGroupObject*)q->ptr;
				break;
			case SOAP_TYPE_tns__groupResponse:
			...
			case SOAP_TYPE_tns__helloResponse:
				...
				break;
			case SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint:
				DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_delete(tns__ArrayOfSiteStatsDataPoint, %d)\n", q->size));
				if (q->size < 0)
					delete (tns__ArrayOfSiteStatsDataPoint*)q->ptr;
				else
					delete[] (tns__ArrayOfSiteStatsDataPoint*)q->ptr;
				break;
			case SOAP_TYPE_tns__getSiteStatsResponse:
...
void tns__ArrayOfSiteStatsDataPoint::soap_serialize(struct soap *soap) const
{
	if (!soap_reference(soap, this, SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint))
		this->soap_mark(soap);
}

void tns__ArrayOfSiteStatsDataPoint::soap_mark(struct soap *soap) const
{
}

void tns__ArrayOfSiteStatsDataPoint::soap_default(struct soap *soap)
{
}

int tns__ArrayOfSiteStatsDataPoint::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	int i = soap_embed_element(soap, (void*)this, tag, SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint);
	this->soap_out(soap, tag, i, type);
	return soap_putindependent(soap);
}

int tns__ArrayOfSiteStatsDataPoint::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out_tns__ArrayOfSiteStatsDataPoint(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_tns__ArrayOfSiteStatsDataPoint(struct soap *soap, const char *tag, int id, const tns__ArrayOfSiteStatsDataPoint *a, const char *type)
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint), "tns:ArrayOfSiteStatsDataPoint");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}

void *tns__ArrayOfSiteStatsDataPoint::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get_tns__ArrayOfSiteStatsDataPoint(soap, this, tag, type);
}

SOAP_FMAC3 tns__ArrayOfSiteStatsDataPoint * SOAP_FMAC4 soap_get_tns__ArrayOfSiteStatsDataPoint(struct soap *soap, tns__ArrayOfSiteStatsDataPoint *p, const char *tag, const char *type)
{
	if ((p = soap_in_tns__ArrayOfSiteStatsDataPoint(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

void *tns__ArrayOfSiteStatsDataPoint::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in_tns__ArrayOfSiteStatsDataPoint(soap, tag, this, type);
}

SOAP_FMAC3 tns__ArrayOfSiteStatsDataPoint * SOAP_FMAC4 soap_in_tns__ArrayOfSiteStatsDataPoint(struct soap *soap, const char *tag, tns__ArrayOfSiteStatsDataPoint *a, const char *type)
{
	if (soap_element_begin_in(soap, tag))
		return NULL;
	if (soap->null)
		...
		{	soap->error = SOAP_NULL;
			...
			return a;
	if (!*soap->href)
	{	if (!(a = (tns__ArrayOfSiteStatsDataPoint *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint, sizeof(tns__ArrayOfSiteStatsDataPoint), soap->type, soap->arrayType)))
		{	soap->error = SOAP_TAG_MISMATCH;
			return NULL;
		}
		if (soap->alloced)
		{	a->soap_default(soap);
			if (soap->clist->type != SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint)
			{	soap_revert(soap);
				*soap->id = '\0';
				return (tns__ArrayOfSiteStatsDataPoint *)a->soap_in(soap, tag, type);
			}
		};
		if (soap->body)
		{	for (;;)
	...
	{	a = (tns__ArrayOfSiteStatsDataPoint *)soap_id_forward(soap, soap->href, (void**)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint, sizeof(tns__ArrayOfSiteStatsDataPoint), soap->type, soap->arrayType), SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint, sizeof(tns__ArrayOfSiteStatsDataPoint));
		if (soap->alloced)
			a->soap_default(soap);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
...
SOAP_FMAC3 tns__ArrayOfSiteStatsDataPoint * SOAP_FMAC4 soap_new_tns__ArrayOfSiteStatsDataPoint(struct soap *soap, int n)
{	return soap_instantiate_tns__ArrayOfSiteStatsDataPoint(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_delete_tns__ArrayOfSiteStatsDataPoint(struct soap *soap, tns__ArrayOfSiteStatsDataPoint *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 tns__ArrayOfSiteStatsDataPoint * SOAP_FMAC4 soap_instantiate_tns__ArrayOfSiteStatsDataPoint(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_tns__ArrayOfSiteStatsDataPoint(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint, n);
	if (!cp)
		return NULL;
	soap->alloced = 1;
	if (n < 0)
	{	cp->ptr = (void*)new tns__ArrayOfSiteStatsDataPoint;
		if (size)
			*size = sizeof(tns__ArrayOfSiteStatsDataPoint);
	}
	else
	{	cp->ptr = (void*)new tns__ArrayOfSiteStatsDataPoint[n];
		if (size)
			*size = n * sizeof(tns__ArrayOfSiteStatsDataPoint);
	}
	return (tns__ArrayOfSiteStatsDataPoint*)cp->ptr;
}
...
{
	soap_embedded(soap, &((tns__getSiteStatsResponse*)this)->_siteStats, SOAP_TYPE_PointerTotns__ArrayOfSiteStatsDataPoint);
	soap_mark_PointerTotns__ArrayOfSiteStatsDataPoint(soap, &((tns__getSiteStatsResponse*)this)->_siteStats);
}

void tns__getSiteStatsResponse::soap_default(struct soap *soap)
{
	soap_default_PointerTotns__ArrayOfSiteStatsDataPoint(soap, &((tns__getSiteStatsResponse*)this)->_siteStats);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_tns__getSiteStatsResponse(struct soap *soap, const char *tag, int id, const tns__getSiteStatsResponse *a, const char *type)
{
	...
	soap_out_PointerTotns__ArrayOfSiteStatsDataPoint(soap, "siteStats", -1, &(((tns__getSiteStatsResponse*)a)->_siteStats), "tns:ArrayOfSiteStatsDataPoint");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}
	...
	{	if (!(a = (tns__getSiteStatsResponse *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_tns__getSiteStatsResponse, sizeof(tns__getSiteStatsResponse), soap->type, soap->arrayType)))
		...
		{	for (;;)
			...
			if (soap_flag__siteStats1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTotns__ArrayOfSiteStatsDataPoint(soap, NULL, &(((tns__getSiteStatsResponse*)a)->_siteStats), "tns:ArrayOfSiteStatsDataPoint"))
...
void tns__ArrayOfGroupObject::soap_serialize(struct soap *soap) const
{
	if (!soap_reference(soap, this, SOAP_TYPE_tns__ArrayOfGroupObject))
		this->soap_mark(soap);
}

void tns__ArrayOfGroupObject::soap_mark(struct soap *soap) const
{
}

void tns__ArrayOfGroupObject::soap_default(struct soap *soap)
{
}

int tns__ArrayOfGroupObject::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	int i = soap_embed_element(soap, (void*)this, tag, SOAP_TYPE_tns__ArrayOfGroupObject);
	this->soap_out(soap, tag, i, type);
	return soap_putindependent(soap);
}

int tns__ArrayOfGroupObject::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out_tns__ArrayOfGroupObject(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_tns__ArrayOfGroupObject(struct soap *soap, const char *tag, int id, const tns__ArrayOfGroupObject *a, const char *type)
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_tns__ArrayOfGroupObject), "tns:ArrayOfGroupObject");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}

void *tns__ArrayOfGroupObject::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get_tns__ArrayOfGroupObject(soap, this, tag, type);
}

SOAP_FMAC3 tns__ArrayOfGroupObject * SOAP_FMAC4 soap_get_tns__ArrayOfGroupObject(struct soap *soap, tns__ArrayOfGroupObject *p, const char *tag, const char *type)
{
	if ((p = soap_in_tns__ArrayOfGroupObject(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

void *tns__ArrayOfGroupObject::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in_tns__ArrayOfGroupObject(soap, tag, this, type);
}

SOAP_FMAC3 tns__ArrayOfGroupObject * SOAP_FMAC4 soap_in_tns__ArrayOfGroupObject(struct soap *soap, const char *tag, tns__ArrayOfGroupObject *a, const char *type)
{
	if (soap_element_begin_in(soap, tag))
		return NULL;
	if (soap->null)
		...
		{	soap->error = SOAP_NULL;
			...
			return a;
	if (!*soap->href)
	{	if (!(a = (tns__ArrayOfGroupObject *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_tns__ArrayOfGroupObject, sizeof(tns__ArrayOfGroupObject), soap->type, soap->arrayType)))
		{	soap->error = SOAP_TAG_MISMATCH;
			return NULL;
		}
		if (soap->alloced)
		{	a->soap_default(soap);
			if (soap->clist->type != SOAP_TYPE_tns__ArrayOfGroupObject)
			{	soap_revert(soap);
				*soap->id = '\0';
				return (tns__ArrayOfGroupObject *)a->soap_in(soap, tag, type);
			}
		};
		if (soap->body)
		{	for (;;)
	...
	{	a = (tns__ArrayOfGroupObject *)soap_id_forward(soap, soap->href, (void**)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_tns__ArrayOfGroupObject, sizeof(tns__ArrayOfGroupObject), soap->type, soap->arrayType), SOAP_TYPE_tns__ArrayOfGroupObject, sizeof(tns__ArrayOfGroupObject));
		if (soap->alloced)
			a->soap_default(soap);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
...
SOAP_FMAC3 tns__ArrayOfGroupObject * SOAP_FMAC4 soap_new_tns__ArrayOfGroupObject(struct soap *soap, int n)
{	return soap_instantiate_tns__ArrayOfGroupObject(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_delete_tns__ArrayOfGroupObject(struct soap *soap, tns__ArrayOfGroupObject *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 tns__ArrayOfGroupObject * SOAP_FMAC4 soap_instantiate_tns__ArrayOfGroupObject(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_tns__ArrayOfGroupObject(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_tns__ArrayOfGroupObject, n);
	if (!cp)
		return NULL;
	soap->alloced = 1;
	if (n < 0)
	{	cp->ptr = (void*)new tns__ArrayOfGroupObject;
		if (size)
			*size = sizeof(tns__ArrayOfGroupObject);
	}
	else
	{	cp->ptr = (void*)new tns__ArrayOfGroupObject[n];
		if (size)
			*size = n * sizeof(tns__ArrayOfGroupObject);
	}
	return (tns__ArrayOfGroupObject*)cp->ptr;
}
...
{
	soap_embedded(soap, &((tns__groupResponse*)this)->_groupResponse, SOAP_TYPE_PointerTotns__ArrayOfGroupObject);
	soap_mark_PointerTotns__ArrayOfGroupObject(soap, &((tns__groupResponse*)this)->_groupResponse);
}

void tns__groupResponse::soap_default(struct soap *soap)
{
	soap_default_PointerTotns__ArrayOfGroupObject(soap, &((tns__groupResponse*)this)->_groupResponse);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_tns__groupResponse(struct soap *soap, const char *tag, int id, const tns__groupResponse *a, const char *type)
{
	...
	soap_out_PointerTotns__ArrayOfGroupObject(soap, "groupResponse", -1, &(((tns__groupResponse*)a)->_groupResponse), "tns:ArrayOfGroupObject");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}
	...
	{	if (!(a = (tns__groupResponse *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_tns__groupResponse, sizeof(tns__groupResponse), soap->type, soap->arrayType)))
		...
		{	for (;;)
			...
			if (soap_flag__groupResponse1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTotns__ArrayOfGroupObject(soap, NULL, &(((tns__groupResponse*)a)->_groupResponse), "tns:ArrayOfGroupObject"))
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTotns__ArrayOfSiteStatsDataPoint(struct soap *soap, tns__ArrayOfSiteStatsDataPoint *const*a)
{
	if (!soap_reference(soap, a, SOAP_TYPE_PointerTotns__ArrayOfSiteStatsDataPoint))
		soap_mark_PointerTotns__ArrayOfSiteStatsDataPoint(soap, a);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_mark_PointerTotns__ArrayOfSiteStatsDataPoint(struct soap *soap, tns__ArrayOfSiteStatsDataPoint *const*a)
{
	if (!soap_reference(soap, *a, SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint))
		(*a)->soap_mark(soap);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_PointerTotns__ArrayOfSiteStatsDataPoint(struct soap *soap, tns__ArrayOfSiteStatsDataPoint **a)
{
	*a = NULL;
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTotns__ArrayOfSiteStatsDataPoint(struct soap *soap, tns__ArrayOfSiteStatsDataPoint **a, const char *tag, const char *type)
{
	int i = soap_embed_element(soap, (void*)a, tag, SOAP_TYPE_PointerTotns__ArrayOfSiteStatsDataPoint);
	soap_out_PointerTotns__ArrayOfSiteStatsDataPoint(soap, tag, i, a, type);
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTotns__ArrayOfSiteStatsDataPoint(struct soap *soap, const char *tag, int id, tns__ArrayOfSiteStatsDataPoint *const*a, const char *type)
{
	struct soap_plist *pp;
	register int i;
	id = soap_embedded_id(soap, id, a, SOAP_TYPE_PointerTotns__ArrayOfSiteStatsDataPoint);
	if (!*a)
		return soap_element_null(soap, tag, id, type);
	i = soap_pointer_lookup(soap, *a, SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint, &pp);
	if (i)
	{	if (soap_is_embedded(soap, pp))
			return soap_element_ref(soap, tag, id, i);
		if (soap_is_single(soap, pp))
	...
	return (*a)->soap_out(soap, tag, soap_pointer_enter(soap, *a, SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint, &pp), type);
}

SOAP_FMAC3 tns__ArrayOfSiteStatsDataPoint ** SOAP_FMAC4 soap_get_PointerTotns__ArrayOfSiteStatsDataPoint(struct soap *soap, tns__ArrayOfSiteStatsDataPoint **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTotns__ArrayOfSiteStatsDataPoint(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC3 tns__ArrayOfSiteStatsDataPoint ** SOAP_FMAC4 soap_in_PointerTotns__ArrayOfSiteStatsDataPoint(struct soap *soap, const char *tag, tns__ArrayOfSiteStatsDataPoint **a, const char *type)
{
	if (soap_element_begin_in(soap, tag))
		return NULL;
	if (soap->null)
	{	a = (tns__ArrayOfSiteStatsDataPoint **)soap_id_enter(soap, soap->id, a, SOAP_TYPE_PointerTotns__ArrayOfSiteStatsDataPoint, sizeof(tns__ArrayOfSiteStatsDataPoint *), 1);
		if (a)
			*a = NULL;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	...
	{	soap_revert(soap);
		a = (tns__ArrayOfSiteStatsDataPoint **)soap_id_enter(soap, "", a, SOAP_TYPE_PointerTotns__ArrayOfSiteStatsDataPoint, sizeof(tns__ArrayOfSiteStatsDataPoint *), 0);
		if (a)
		{	if (soap->alloced || !*a)
				*a = (tns__ArrayOfSiteStatsDataPoint *)soap_instantiate_tns__ArrayOfSiteStatsDataPoint(soap, -1, soap->type, soap->arrayType, NULL);
			if (!*a)
				a = NULL;
			else
			{	(*a)->soap_default(soap);
	...
	{	a = (tns__ArrayOfSiteStatsDataPoint **)soap_id_lookup(soap, soap->href, (void**)soap_id_enter(soap, soap->id, a, SOAP_TYPE_PointerTotns__ArrayOfSiteStatsDataPoint, sizeof(tns__ArrayOfSiteStatsDataPoint *), 1), SOAP_TYPE_tns__ArrayOfSiteStatsDataPoint, sizeof(tns__ArrayOfSiteStatsDataPoint), 0);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTotns__ArrayOfGroupObject(struct soap *soap, tns__ArrayOfGroupObject *const*a)
{
	if (!soap_reference(soap, a, SOAP_TYPE_PointerTotns__ArrayOfGroupObject))
		soap_mark_PointerTotns__ArrayOfGroupObject(soap, a);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_mark_PointerTotns__ArrayOfGroupObject(struct soap *soap, tns__ArrayOfGroupObject *const*a)
{
	if (!soap_reference(soap, *a, SOAP_TYPE_tns__ArrayOfGroupObject))
		(*a)->soap_mark(soap);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_PointerTotns__ArrayOfGroupObject(struct soap *soap, tns__ArrayOfGroupObject **a)
{
	*a = NULL;
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTotns__ArrayOfGroupObject(struct soap *soap, tns__ArrayOfGroupObject **a, const char *tag, const char *type)
{
	int i = soap_embed_element(soap, (void*)a, tag, SOAP_TYPE_PointerTotns__ArrayOfGroupObject);
	soap_out_PointerTotns__ArrayOfGroupObject(soap, tag, i, a, type);
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTotns__ArrayOfGroupObject(struct soap *soap, const char *tag, int id, tns__ArrayOfGroupObject *const*a, const char *type)
{
	struct soap_plist *pp;
	register int i;
	id = soap_embedded_id(soap, id, a, SOAP_TYPE_PointerTotns__ArrayOfGroupObject);
	if (!*a)
		return soap_element_null(soap, tag, id, type);
	i = soap_pointer_lookup(soap, *a, SOAP_TYPE_tns__ArrayOfGroupObject, &pp);
	if (i)
	{	if (soap_is_embedded(soap, pp))
			return soap_element_ref(soap, tag, id, i);
		if (soap_is_single(soap, pp))
	...
	return (*a)->soap_out(soap, tag, soap_pointer_enter(soap, *a, SOAP_TYPE_tns__ArrayOfGroupObject, &pp), type);
}

SOAP_FMAC3 tns__ArrayOfGroupObject ** SOAP_FMAC4 soap_get_PointerTotns__ArrayOfGroupObject(struct soap *soap, tns__ArrayOfGroupObject **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTotns__ArrayOfGroupObject(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC3 tns__ArrayOfGroupObject ** SOAP_FMAC4 soap_in_PointerTotns__ArrayOfGroupObject(struct soap *soap, const char *tag, tns__ArrayOfGroupObject **a, const char *type)
{
	if (soap_element_begin_in(soap, tag))
		return NULL;
	if (soap->null)
	{	a = (tns__ArrayOfGroupObject **)soap_id_enter(soap, soap->id, a, SOAP_TYPE_PointerTotns__ArrayOfGroupObject, sizeof(tns__ArrayOfGroupObject *), 1);
		if (a)
			*a = NULL;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	...
	{	soap_revert(soap);
		a = (tns__ArrayOfGroupObject **)soap_id_enter(soap, "", a, SOAP_TYPE_PointerTotns__ArrayOfGroupObject, sizeof(tns__ArrayOfGroupObject *), 0);
		if (a)
		{	if (soap->alloced || !*a)
				*a = (tns__ArrayOfGroupObject *)soap_instantiate_tns__ArrayOfGroupObject(soap, -1, soap->type, soap->arrayType, NULL);
			if (!*a)
				a = NULL;
			else
			{	(*a)->soap_default(soap);
	...
	{	a = (tns__ArrayOfGroupObject **)soap_id_lookup(soap, soap->href, (void**)soap_id_enter(soap, soap->id, a, SOAP_TYPE_PointerTotns__ArrayOfGroupObject, sizeof(tns__ArrayOfGroupObject *), 1), SOAP_TYPE_tns__ArrayOfGroupObject, sizeof(tns__ArrayOfGroupObject), 0);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
